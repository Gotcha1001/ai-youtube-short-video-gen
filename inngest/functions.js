...
export const GenerateVideoData = inngest.createFunction(
  ...
  async ({ event, step }) => {
    ...
    //     const fps = 30;
    //     const calculatedDuration = lastCaption ? Math.ceil(lastCaption.end * fps) : 360;

    //     console.log("🔥 Exporting video with duration:", calculatedDuration);

    //     // Create a modified version of your video data with the explicit duration
    //     const exportVideoData = {
    //       audioUrl: GenerateAudioFile,
    //       captionJson: GenerateCaptions,
    //       images: GenerateImages,
    //       // Add an explicit duration property that will be used in the composition
